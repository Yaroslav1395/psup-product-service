...
==== Тело ответа
include::{snippets}/update-category/response-body.adoc[]
...
Дубликат:
include::{snippets}/update-category-duplicate/http-response.adoc[]

Ошибка валидации:
include::{snippets}/update-category-validation-error/http-response.adoc[]

Описание полей при ошибке

include::{snippets}/update-category-duplicate/response-fields.adoc[]
...
==== HTTP-запрос
include::{snippets}/delete-category/httpie-request.adoc[]
...
==== Тело ответа
include::{snippets}/delete-category/response-body.adoc[]
